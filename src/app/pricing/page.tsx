...
const FREE = [
  ...
  "Все четыре HR-взгляда",
  "Публичная карточка и шаринг",
  "Разбор вакансии и сопоставление",
];
      ...
      <main id="main" className="flex flex-1 flex-col">
        <section className="pricing">
          <div className="ph">
            ...
            <h1>Понять проблему — <span>бесплатно.</span><br />Получить готовую версию — за деньги.</h1>
            <p>Никакой подписки. Сначала видишь полный разбор, потом сам решаешь, нужно ли исправлять документ.</p>
          </div>
          ...
          <div className="grid">
            ...
            <div className="card pro">
              <div className="c-top">
                <div className="c-k thr-mono">Реванш <span className="beta">цена беты</span></div>
                <div className="price toxic">{REVENGE_PRICE_RUB} ₽ <span>/ один раз</span></div>
              </div>
          ...
          <div className="why">
            ...
            <p>Саркастичный разбор — вход в продукт и способ понять, есть ли проблема. Деньги появляются только там, где ToxicHR делает за тебя конкретную работу и отдаёт готовый документ.</p>
          </div>
        </section>
      </main>
