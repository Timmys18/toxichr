  ...
  return (
    <>
      <main id="main" className="privacy">
        ...
        <section>
          <h2>Поддержка и возврат</h2>
          <p>По вопросам оплаты и возврата используй канал поддержки из платёжной квитанции. Мы не публикуем выдуманные контакты; при обращении укажи email аккаунта и номер платежа.</p>
        </section>
