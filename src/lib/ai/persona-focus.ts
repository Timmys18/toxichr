...
const optics = {
  ...
  vadik: { angle: "Личное действие и практическая польза", terms: /пров[её]л|спроектир|пересобр|внедр|запуст|устран|обуч|подготов|утверд|перераспредел|личн/giu, question: "Что из описанного ты сделал сам и какую рабочую проблему это сняло?" },
