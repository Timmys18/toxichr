  ...
  return (
    <nav className="topnav">
      ...
      <style>{`
        ...
        .links{display:flex;gap:36px}.links a{font-size:15px;font-weight:600;color:rgba(242,244,245,.68);text-decoration:none;transition:.2s}.links a:hover{color:var(--fg)}
        .right{display:flex;align-items:center;gap:10px}.login{font-size:15px;font-weight:700;color:var(--fg);text-decoration:none;border:1px solid rgba(242,244,245,.3);padding:12px 22px;border-radius:12px;transition:.2s}.login:hover{border-color:rgba(242,244,245,.55);background:rgba(255,255,255,.06)}
